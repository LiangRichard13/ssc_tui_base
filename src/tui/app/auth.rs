...
impl App {
    ...
    // Stage 2C (chore/ssc-tui-baseline): the SAITEC-backend TUI update push
    // is retired. handle_update_status, start_tui_update_download, and
    // cancel_tui_update_download are removed; the App no longer carries the
    // pending_tui_update / tui_update_progress / tui_update_download_cancel
    // fields or the [U] /download-latest / Esc-cancel wiring.
