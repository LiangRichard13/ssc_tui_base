...
impl App {
    ...
    pub(super) fn new_minimal_with_session(
        ...
        let mut app = Self {
            ...
            stashed_input: None,
            submitted_input_history: SubmittedInputHistory::default(),
            ...
            pending_login: None,
            pending_text_entry_focus: super::PendingTextEntryFocus::Input,
            ...
            // Stage 2C: TUI update push state fields removed
        };
