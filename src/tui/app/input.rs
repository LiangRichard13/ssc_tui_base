...
pub(super) fn handle_pre_control_shortcuts(
    ...
    // Stage 2C: 'u' / '/download-latest' / Esc-cancel-download wiring removed
...
pub(super) fn handle_modal_key(
    ...
    // Stage 2C: download-running Esc-cancel removed.
...
impl App {
    ...
    pub(super) fn submit_input(&mut self) {
        ...
        // Stage 2C: /download-latest command removed (SAITEC backend push retired).
