...
const REGISTERED_COMMANDS: &[RegisteredCommand] = &[
    ...
    RegisteredCommand::public("/feedback", "Send feedback about SSC-TUI"),
    RegisteredCommand::public("/subscription", "Show SSC-TUI subscription status"),
    ...
    RegisteredCommand::public("/selfdev", "Open a new self-dev SSC-TUI session"),
