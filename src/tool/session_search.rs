...
struct SearchInput {
    ...
    /// Restrict SSC-TUI sessions by saved/bookmarked flag.
    #[serde(default)]
    saved: Option<bool>,
    /// Restrict SSC-TUI sessions by debug flag.
    #[serde(default)]
    debug: Option<bool>,
    /// Restrict SSC-TUI sessions by canary flag.
    #[serde(default)]
    canary: Option<bool>,
    ...
    fn parameters_schema(&self) -> Value {
        json!({
            ...
            "properties": {
                ...
                "saved": {
                    "type": "boolean",
                    "description": "Restrict SSC-TUI sessions by saved/bookmarked flag."
                },
                "debug": {
                    "type": "boolean",
                    "description": "Restrict SSC-TUI sessions by debug/test flag."
                },
                "canary": {
                    "type": "boolean",
                    "description": "Restrict SSC-TUI sessions by canary flag."
                },
                "source": {
                    "type": "string",
